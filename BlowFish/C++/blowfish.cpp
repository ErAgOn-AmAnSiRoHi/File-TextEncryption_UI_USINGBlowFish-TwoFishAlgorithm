...
int main(int argc, char const *argv[]) {
  std::string key("jbdkjnKJnkjka");
  std::string message("My name is Aman and I am a panda");
  std::string cipher("");
  ...
  std::string decipher("");
  std::cout << "My encrypted message is: " << cipher << std::endl;
  ...
  std::cout << "My decrypted message is: " << decipher << std::endl;
  if (message == decipher) {
    return 0;
  } else {
    return 1;
